...
def worker_window():
    ...
    floor1_image = ImageTk.PhotoImage(Image.open("C:\osnovnoe\pythonE\ew\g\hotels\Logo.png"))
...
def window_main():
    ...
    img1 = ImageTk.PhotoImage(Image.open("C:\osnovnoe\pythonE\ew\g\hotels\Logo.png").resize((400,200)))
